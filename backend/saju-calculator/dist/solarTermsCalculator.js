...
// 근사 계산 (폴백)
// ============================================================
function getApproximateSolarMonth(month, day) {
...
// 유틸리티
// ============================================================
function dateTimeToMinutes(year, month, day, hour, minute) {
    const date = new Date(year, month - 1, day, hour, minute);
    return Math.floor(date.getTime() / (1000 * 60));
}
function termToMinutes(term) {
...
function minutesToDaysHoursMinutes(totalMinutes) {
...
//# sourceMappingURL=solarTermsCalculator.js.map